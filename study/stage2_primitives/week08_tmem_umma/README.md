...
预计 ~15h
> **硬件**：B200（SM100，租 1-2 hr sprint 实跑）。承接 W5-W7 的 SM100 增量学习（紧跟 SM90 prim 趁热打铁）
...
> - **FP4/FP6/MX**（A3）：本周只跑 F16，但读 `tcgen05.mma.kind::*` 时留意 `f8f6f4`/`mxf4`/`nvf4` —— W13 量化 GEMM 会实跑这条通路（LLM 推理刚需）
