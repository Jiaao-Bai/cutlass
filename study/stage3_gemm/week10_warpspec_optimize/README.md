...
## 跑
```bash
make study_stage3_w10_ex_warpspec_gemm_v2 -j
./study_stage3_w10_ex_warpspec_gemm_v2 4096 4096 4096

ncu --set full -o v2 ./study_stage3_w10_ex_warpspec_gemm_v2 4096 4096 4096
```
