...
## 读
- 复习 `study/stage3_hopper_gemm/week09/exercises/ex_warpspec_gemm_v1.cu`（你的 GEMM v1）
...
## 跑
```bash
python study/stage4_flashattn/week13_fa_fwd_writeup/exercises/ref_torch.py  # 生成参考
make study_stage4_w13_ex_fa_fwd_v1 -j
./study_stage4_w13_ex_fa_fwd_v1
